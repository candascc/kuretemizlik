<?php
/**
 * Admin (test_admin) Crawl Script
 * 
 * PATH_CRAWL_ADMIN_V1: Crawls all admin accessible pages
 * 
 * Usage:
 *   php tests/ui/crawl_admin.php [base_url] [username] [password]
 * 
 * Environment Variables:
 *   KUREAPP_ADMIN_USER (default: test_admin)
 *   KUREAPP_ADMIN_PASS (default: 12dream21)
...
$username = $argv[2] ?? getenv('KUREAPP_ADMIN_USER') ?: 'test_admin';
$password = $argv[3] ?? getenv('KUREAPP_ADMIN_PASS') ?: '12dream21';

// Log file
$logFile = __DIR__ . '/../../logs/crawl_admin_' . date('Y-m-d_H-i-s') . '.log';

echo "=== PATH_CRAWL_ADMIN_V1: Admin Crawl Test ===\n";
echo "Base URL: {$baseUrl}\n";
echo "Username: {$username}\n";
echo "Log File: {$logFile}\n\n";

// PATH_CRAWL_ADMIN_V1: Use AdminCrawlRunner for both CLI and web
